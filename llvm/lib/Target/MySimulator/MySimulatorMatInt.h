//===- MySimulatorMatInt.h - Immediate materialisation ---------------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_MY_SIMULATOR_MCTARGETDESC_MATINT_H
#define LLVM_LIB_TARGET_MY_SIMULATOR_MCTARGETDESC_MATINT_H
...
// MySimulatorple struct is produced rather than directly emitting the instructions in
