//===-- MySimulatorELFStreamer.h - MySimulator ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_MY_SIMULATOR_MCTARGETDESC_MySimulatorELFSTREAMER_H
#define LLVM_LIB_TARGET_MY_SIMULATOR_MCTARGETDESC_MySimulatorELFSTREAMER_H
...
class MySimulatorTargetELFStreamer : public MySimulatorTargetStreamer {
private:
...
public:
  ...
  MySimulatorTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
