//===-- MySimulatorISAInfo.cpp - MySimulator Arch String Parser --------------===//
//
...
struct MySimulatorExtensionVersion {
  unsigned Major;
  unsigned Minor;
};

struct MySimulatorSupportedExtension {
  const char *Name;
  /// Supported version.
  MySimulatorExtensionVersion Version;
};
...
static const MySimulatorSupportedExtension SupportedExtensions[] = {
    {"i", MySimulatorExtensionVersion{2, 0}},
    {"e", MySimulatorExtensionVersion{1, 9}},
    {"m", MySimulatorExtensionVersion{2, 0}},
    {"a", MySimulatorExtensionVersion{2, 0}},
    {"f", MySimulatorExtensionVersion{2, 0}},
    {"d", MySimulatorExtensionVersion{2, 0}},
    {"c", MySimulatorExtensionVersion{2, 0}},

    {"zfhmin", MySimulatorExtensionVersion{1, 0}},
    {"zfh", MySimulatorExtensionVersion{1, 0}},

    {"zba", MySimulatorExtensionVersion{1, 0}},
    {"zbb", MySimulatorExtensionVersion{1, 0}},
    {"zbc", MySimulatorExtensionVersion{1, 0}},
    {"zbs", MySimulatorExtensionVersion{1, 0}},

    {"zbkb", MySimulatorExtensionVersion{1, 0}},
    {"zbkc", MySimulatorExtensionVersion{1, 0}},
    {"zbkx", MySimulatorExtensionVersion{1, 0}},
    {"zknd", MySimulatorExtensionVersion{1, 0}},
    {"zkne", MySimulatorExtensionVersion{1, 0}},
    {"zknh", MySimulatorExtensionVersion{1, 0}},
    {"zksed", MySimulatorExtensionVersion{1, 0}},
    {"zksh", MySimulatorExtensionVersion{1, 0}},
    {"zkr", MySimulatorExtensionVersion{1, 0}},
    {"zkn", MySimulatorExtensionVersion{1, 0}},
    {"zks", MySimulatorExtensionVersion{1, 0}},
    {"zkt", MySimulatorExtensionVersion{1, 0}},
    {"zk", MySimulatorExtensionVersion{1, 0}},

    {"v", MySimulatorExtensionVersion{1, 0}},
    {"zvl32b", MySimulatorExtensionVersion{1, 0}},
    {"zvl64b", MySimulatorExtensionVersion{1, 0}},
    {"zvl128b", MySimulatorExtensionVersion{1, 0}},
    {"zvl256b", MySimulatorExtensionVersion{1, 0}},
    {"zvl512b", MySimulatorExtensionVersion{1, 0}},
    {"zvl1024b", MySimulatorExtensionVersion{1, 0}},
    {"zvl2048b", MySimulatorExtensionVersion{1, 0}},
    {"zvl4096b", MySimulatorExtensionVersion{1, 0}},
    {"zvl8192b", MySimulatorExtensionVersion{1, 0}},
    {"zvl16384b", MySimulatorExtensionVersion{1, 0}},
    {"zvl32768b", MySimulatorExtensionVersion{1, 0}},
    {"zvl65536b", MySimulatorExtensionVersion{1, 0}},
    {"zve32x", MySimulatorExtensionVersion{1, 0}},
    {"zve32f", MySimulatorExtensionVersion{1, 0}},
    {"zve64x", MySimulatorExtensionVersion{1, 0}},
    {"zve64f", MySimulatorExtensionVersion{1, 0}},
    {"zve64d", MySimulatorExtensionVersion{1, 0}},
};

static const MySimulatorSupportedExtension SupportedExperimentalExtensions[] = {
    {"zbe", MySimulatorExtensionVersion{0, 93}},
    {"zbf", MySimulatorExtensionVersion{0, 93}},
    {"zbm", MySimulatorExtensionVersion{0, 93}},
    {"zbp", MySimulatorExtensionVersion{0, 93}},
    {"zbr", MySimulatorExtensionVersion{0, 93}},
    {"zbt", MySimulatorExtensionVersion{0, 93}},
};
...
struct FindByName {
  ...
  StringRef Ext;
  bool operator()(const MySimulatorSupportedExtension &ExtInfo) {
    return ExtInfo.Name == Ext;
  }
};

static Optional<MySimulatorExtensionVersion> findDefaultVersion(StringRef ExtName) {
...
void MySimulatorISAInfo::addExtension(StringRef ExtName, unsigned MajorVersion,
                                unsigned MinorVersion) {
  MySimulatorExtensionInfo Ext;
...
static Optional<MySimulatorExtensionVersion> isExperimentalExtension(StringRef Ext) {
  auto ExtIterator =
...
bool MySimulatorISAInfo::isSupportedExtensionFeature(StringRef Ext) {
...
bool MySimulatorISAInfo::isSupportedExtension(StringRef Ext) {
  return llvm::any_of(SupportedExtensions, FindByName(Ext)) ||
         llvm::any_of(SupportedExperimentalExtensions, FindByName(Ext));
}

bool MySimulatorISAInfo::isSupportedExtension(StringRef Ext, unsigned MajorVersion,
                                        unsigned MinorVersion) {
  auto FindByNameAndVersion = [=](const MySimulatorSupportedExtension &ExtInfo) {
...
bool MySimulatorISAInfo::hasExtension(StringRef Ext) const {
...
bool MySimulatorISAInfo::compareExtension(const std::string &LHS,
...
void MySimulatorISAInfo::toFeatures(
...
static Error getExtensionVersion(StringRef Ext, StringRef In, unsigned &Major,
  ...
  if (MySimulatorISAInfo::isSupportedExtension(Ext, Major, Minor))
    return Error::success();
...
llvm::Expected<std::unique_ptr<MySimulatorISAInfo>>
MySimulatorISAInfo::parseFeatures(unsigned XLen,
                            const std::vector<std::string> &Features) {
  assert(XLen == 32 || XLen == 64);
  std::unique_ptr<MySimulatorISAInfo> ISAInfo(new MySimulatorISAInfo(XLen));
  ...
  return MySimulatorISAInfo::postProcessAndChecking(std::move(ISAInfo));
}

llvm::Expected<std::unique_ptr<MySimulatorISAInfo>>
MySimulatorISAInfo::parseArchString(StringRef Arch, bool EnableExperimentalExtension,
                              bool ExperimentalExtensionVersionCheck) {
...
Error MySimulatorISAInfo::checkDependency() {
  bool IsRv32 = XLen == 32;
...
void MySimulatorISAInfo::updateImplication() {
  bool HasE = Exts.count("e") != 0;
...
void MySimulatorISAInfo::updateFLen() {
  FLen = 0;
...
void MySimulatorISAInfo::updateMinVLen() {
  for (auto const &Ext : Exts) {
    StringRef ExtName = Ext.first;
...
void MySimulatorISAInfo::updateMaxELen() {
...
std::string MySimulatorISAInfo::toString() const {
  std::string Buffer;
...
std::vector<std::string> MySimulatorISAInfo::toFeatureVector() const {
...
llvm::Expected<std::unique_ptr<MySimulatorISAInfo>>
MySimulatorISAInfo::postProcessAndChecking(std::unique_ptr<MySimulatorISAInfo> &&ISAInfo) {
